...
sidebar = html.Div([
    ...
    html.Div([
        html.Div([
            dbc.Button([
                html.Img(src="./src/dash/assets/icons/info.svg",
        ...
        html.Div([
            dbc.Button([
                html.Img(src="./src/dash/assets/icons/plus.svg",
                         style={"width": "15px", "padding-bottom": "1px",
                                "margin-right": "5px"}),
                "New analysis"
            ],
    ...
    html.Div([
        html.Div([
            dbc.Button([
                html.Img(src="./src/dash/assets/icons/sliders.svg",
                         style={"width": "15px", "padding-bottom": "1px",
                                "margin-right": "5px"}),
                "Dashboard"
            ],
        ...
        html.Div([
            dbc.Button([
                html.Img(src="./src/dash/assets/icons/alert-triangle.svg",
                         style={"width": "15px", "padding-bottom": "1px",
                                "margin-right": "5px"}),
                "Warnings"
            ],
        ...
        html.Div([
            dbc.Button([
                html.Img(src="./src/dash/assets/icons/layout.svg",
                         style={"width": "15px", "padding-bottom": "1px",
                                "margin-right": "5px"}),
                "Classes"
            ],
        ...
        html.Div([
            dbc.Button([
                html.Img(src="./src/dash/assets/icons/bar-chart-2.svg",
                         style={"width": "15px", "padding-bottom": "1px",
                                "margin-right": "5px"}),
                "Stats"
            ],
        ...
        html.Div([
            dbc.Button([
                html.Img(src="./src/dash/assets/icons/crosshair.svg",
                         style={"width": "15px", "padding-bottom": "1px",
                                "margin-right": "5px"}),
                "Anomalies"
            ],
